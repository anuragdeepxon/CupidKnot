    ...
    <div class="glass rounded-3xl px-4 py-16 sm:mx-6 lg:mx-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="text-center">
                <h4 class="text-3xl text-white font-semibold mt-1 mb-12 pb-1"><?php echo e(config('app.name')); ?> | Onboarding</h4>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cupid\resources\views/auth/update.blade.php ENDPATH**/ ?>