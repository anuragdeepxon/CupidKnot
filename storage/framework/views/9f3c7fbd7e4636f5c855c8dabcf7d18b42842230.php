        ...
        <div class="arya-fly-top-out left relative">
            <div class="arya-fly-top-in">
                <div id="arya-fly-logo" class="left relative logo">
                    <a href="/"><img src="<?php echo e(URL::asset('images/logo.png')); ?>" class="" alt="##" />
...
<header>
    <nav style="height: 50px;" class="fixed mx-auto top-0 left-0 right-0 z-[500] shadow-xl flex bg-[#2A303C] 2xl:px-[11%] xl:px-[11%] lg:px-[11%] md:px-[10rem] sm:px-10 px-5 ">
        ...
        <div class="">
            <div class="">
                <a href="/"><img src="<?php echo e(URL::asset('images/logo.png')); ?>" class="w-16 md:w-18 lg:w-18 p-1 mt-1 md:mt-1 lg:mt-1 inline" alt="##" />
                    <h1 class="mt-2 md:mt-0 lg:mt-0  p-1 font-bold text-white text-xl md:text-3xl lg:text-3xl  self-center" style="float: right;">##</h1>
                </a>
...
<!-- Header end  --><?php /**PATH C:\Users\AnuragDeep\OneDrive\Desktop\Freelancing\days-to\resources\views/layouts/header.blade.php ENDPATH**/ ?>